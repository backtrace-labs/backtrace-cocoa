        ...
        describe("Backtrace Metrics") {
            ...
            context("Events operation") {
                ...
                it("clears the summed event after enabling") {
                    ...
                    guard let summedEvents = metrics?.getSummedEventsPayload() else { return }
                    
                    guard let events = summedEvents.value(forKey: "events") as? [SummedEvent] else { return }
                ...
                it("can add and store unique event") {
                    ...
                    guard let uniqueEvents = metrics?.getUniqueEventsPayload() else { return }
                    
                    guard let events = uniqueEvents.value(forKey: "events") as? [UniqueEvent] else { return }
